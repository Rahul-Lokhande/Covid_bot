...
while True:
    try:
        ...
        api_key=apikey4.API_KEY
        api_key_secret=apikey4.API_KEY_SECRET
        access_token=apikey4.ACCESS_TOKEN
        access_token_secret=apikey4.ACCESS_TOKEN_SECRET
